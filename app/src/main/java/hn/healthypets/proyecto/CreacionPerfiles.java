            ...
            public void onClick(View v) {
                ...
                if (fieldsFill && spiEspecie.getSelectedItemId() > 0 && radioButtonIsSelected) {
                    ...
                    if (metodosImagenes.checkPermissionStorage(CreacionPerfiles.this) || permissionStorgare) {
                        ...
                        Toast.makeText(CreacionPerfiles.this, "Permisos", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(CreacionPerfiles.this, "Campos OBLIGATORIOS(*) vacios", Toast.LENGTH_LONG).show();
                }
            }
        });
