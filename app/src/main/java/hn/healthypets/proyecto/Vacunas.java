...
public class Vacunas extends AppCompatActivity {
    ...
    private void init() {
        ...
        /** Acciones a realizar si se la opcion es actualizar*/
            ...
            edtFechaVacuna.setText(intentValues.getStringExtra(Constantes.TAG_FECHA_APLICACION));
            ...
            //edtPesoDesparacitante.setText(intentValues.getStringExtra(Constantes.TAG_PESO));
        }
